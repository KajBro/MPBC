...
plink2 --bfile MPBC_missing1 --exclude missing_haps_1E4_final.txt --make-bed --out MPBC_missing2
...
mv MPBC_Euro_pihat_mind_missing123.bim FILTERED.MPBC.bim
mv MPBC_Euro_pihat_mind_missing123.bed FILTERED.MPBC.bed
mv MPBC_Euro_pihat_mind_missing123.fam FILTERED.MPBC.fam
